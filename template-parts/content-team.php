...
?>
<div class="col-6 col-sm-4 col-md-4 col-lg-3 mb-100">
    <div class="team-box">
        ...
        <div class="team-member">
            <p class="team-socials mb-3">
                ...
                <?php endif ?>
                 ...
                 <a href="<?= get_the_permalink(); ?>"> <p class="name"><?= the_title() ?></p></a>
                  <a href="<?= get_the_permalink(); ?>"> <p class="designation"><?= $designation[0] ?></p></a>
        </div>
