    ...
    <?php get_header(); ?>
        ...
        <section class="pt-5">
            <div class="container">
                ...
                <h3 class="unit-headings">Unit Lead</h3>
                <?php 
        ...
        if(has_post_thumbnail($leadTeamMember)){
            echo get_the_post_thumbnail($leadTeamMember,'full',array( 'class' => 'img-fluid' )); 
        }else{
        ...
        ?>
                                    <div class="team-member">
                                        <p class="team-socials mb-3">
                                            <?php if(get_field('facebook_url',$leadTeamMember)):?>
                                                <a class="team-facebook team-social-icn" href="<?= get_field('facebook_url',$leadTeamMember) ?>" target="_blank">
                                    ...
                                    c0-4.444,1.059-6.7,6.848-6.7l8.397-0.003c1.082,0,1.959-0.878,1.959-1.96V1.98C74.046,0.899,73.17,0.022,72.089,0.02z"></path>
                                                ...
                                                <?php endif ?>
                                                    <?php if(get_field('twitter_url',$leadTeamMember)):?>
                                                        <a class="team-twitter team-social-icn" href="<?= get_field('twitter_url',$leadTeamMember) ?>" target="_blank">
                                    ...
                                    c3.843-2.811,7.142-6.252,9.802-10.235C97.675,18.929,97.662,18.692,97.523,18.526z"></path>
                                                        ...
                                                        <?php endif ?>
                                                            <?php if(get_field('linkedin_url',$leadTeamMember)):?>
                                                                <a class="team-linkedin team-social-icn" href="<?= get_field('linkedin_url',$leadTeamMember) ?>" target="_blank">
                                                                ...
                                                                <?php endif ?>
                                                                    <?php if(get_field('instagram_url',$leadTeamMember)):?>
                                                                        <a class="team-insta team-social-icn" style="min-width:30px" href="<?= get_field('instagram_url',$leadTeamMember) ?>" target="_blank">
                                                                            <svg class="" width="96.875px" height="96.875px" viewBox="0 0 511 511.9" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="<?= get_the_permalink($leadTeamMember); ?>">
                                            <p class="name">
                                        ...
                                        <a href="<?= get_the_permalink($leadTeamMember); ?>">
                                            <p class="designation">
                                                <?= $designation[0] ?>
                                                                    ...
                                                                    <?php }else{ ?>
<p class="text-center">No Team Lead Assigned</p>
                                                                   <?php } ?>

               
            <h3 class="unit-headings mt-5 mb-5">Unit Staff Members</h3>
                <?php
        ...
        if(has_post_thumbnail($sub_field_value)){
            echo get_the_post_thumbnail($sub_field_value,'full',array( 'class' => 'img-fluid' )); 
        }else{
            echo  '<img src='.get_template_directory_uri().'/assets/images/team.png />';
        }
        ...
        ?>
                                    <div class="team-member">
                                        <p class="team-socials mb-3">
                                            <?php if(get_field('facebook_url',$sub_field_value)):?>
                                                <a class="team-facebook team-social-icn" href="<?= get_field('facebook_url',$sub_field_value) ?>" target="_blank">
                                                    <svg class="mr-lg-4 mr-md-4 mr-1" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="96.124px" height="96.123px" viewBox="0 0 96.124 96.123" style="enable-background:new 0 0 96.124 96.123;" xml:space="preserve">
                                                        <g>
                                                            <path d="M72.089,0.02L59.624,0C45.62,0,36.57,9.285,36.57,23.656v10.907H24.037c-1.083,0-1.96,0.878-1.96,1.961v15.803
                                    c0,1.083,0.878,1.96,1.96,1.96h12.533v39.876c0,1.083,0.877,1.96,1.96,1.96h16.352c1.083,0,1.96-0.878,1.96-1.96V54.287h14.654
                                    ...
                                    c0-4.444,1.059-6.7,6.848-6.7l8.397-0.003c1.082,0,1.959-0.878,1.959-1.96V1.98C74.046,0.899,73.17,0.022,72.089,0.02z"></path>
                                                ...
                                                <?php endif ?>
                                                    <?php if(get_field('twitter_url',$sub_field_value)):?>
                                                        <a class="team-twitter team-social-icn" href="<?= get_field('twitter_url',$sub_field_value) ?>" target="_blank">
                                                            <svg class="mr-lg-4 mr-md-4 mr-1" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="97.637px" height="97.637px" viewBox="0 0 97.637 97.637" style="enable-background:new 0 0 97.637 97.637;" xml:space="preserve">
                                                                <g>
                                                                    <path d="M97.523,18.526c-0.14-0.165-0.371-0.221-0.568-0.131c-2.919,1.295-5.99,2.226-9.153,2.776
                                    c3.358-2.526,5.86-6.024,7.143-10.035c0.062-0.192-0.002-0.402-0.159-0.527c-0.158-0.125-0.377-0.141-0.55-0.038
                                    ...
                                    c3.843-2.811,7.142-6.252,9.802-10.235C97.675,18.929,97.662,18.692,97.523,18.526z"></path>
                                                        ...
                                                        <?php endif ?>
                                                            <?php if(get_field('linkedin_url',$sub_field_value)):?>
                                                                <a class="team-linkedin team-social-icn" href="<?= get_field('linkedin_url',$sub_field_value) ?>" target="_blank">
                                                                    <svg id="Bold" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="m23.994 24v-.001h.006v-8.802c0-4.306-.927-7.623-5.961-7.623-2.42 0-4.044 1.328-4.707 2.587h-.07v-2.185h-4.773v16.023h4.97v-7.934c0-2.089.396-4.109 2.983-4.109 2.549 0 2.587 2.384 2.587 4.243v7.801z" />
                                                                        <path d="m.396 7.977h4.976v16.023h-4.976z" />
                                                                        <path d="m2.882 0c-1.591 0-2.882 1.291-2.882 2.882s1.291 2.909 2.882 2.909 2.882-1.318 2.882-2.909c-.001-1.591-1.292-2.882-2.882-2.882z" />
                                                                ...
                                                                <?php endif ?>
                                                                    <?php if(get_field('instagram_url',$sub_field_value)):?>
                                                                        <a class="team-insta team-social-icn" style="min-width:30px" href="<?= get_field('instagram_url',$sub_field_value) ?>" target="_blank">
                                                                            <svg class="" width="96.875px" height="96.875px" viewBox="0 0 511 511.9" xmlns="http://www.w3.org/2000/svg">
                                                                                <path d="m510.949219 150.5c-1.199219-27.199219-5.597657-45.898438-11.898438-62.101562-6.5-17.199219-16.5-32.597657-29.601562-45.398438-12.800781-13-28.300781-23.101562-45.300781-29.5-16.296876-6.300781-34.898438-10.699219-62.097657-11.898438-27.402343-1.300781-36.101562-1.601562-105.601562-1.601562s-78.199219.300781-105.5 1.5c-27.199219 1.199219-45.898438 5.601562-62.097657 11.898438-17.203124 6.5-32.601562 16.5-45.402343 29.601562-13 12.800781-23.097657 28.300781-29.5 45.300781-6.300781 16.300781-10.699219 34.898438-11.898438 62.097657-1.300781 27.402343-1.601562 36.101562-1.601562 105.601562s.300781 78.199219 1.5 105.5c1.199219 27.199219 5.601562 45.898438 11.902343 62.101562 6.5 17.199219 16.597657 32.597657 29.597657 45.398438 12.800781 13 28.300781 23.101562 45.300781 29.5 16.300781 6.300781 34.898438 10.699219 62.101562 11.898438 27.296876 1.203124 36 1.5 105.5 1.5s78.199219-.296876 105.5-1.5c27.199219-1.199219 45.898438-5.597657 62.097657-11.898438 34.402343-13.300781 61.601562-40.5 74.902343-74.898438 6.296876-16.300781 10.699219-34.902343 11.898438-62.101562 1.199219-27.300781 1.5-36 1.5-105.5s-.101562-78.199219-1.300781-105.5zm-46.097657 209c-1.101562 25-5.300781 38.5-8.800781 47.5-8.601562 22.300781-26.300781 40-48.601562 48.601562-9 3.5-22.597657 7.699219-47.5 8.796876-27 1.203124-35.097657 1.5-103.398438 1.5s-76.5-.296876-103.402343-1.5c-25-1.097657-38.5-5.296876-47.5-8.796876-11.097657-4.101562-21.199219-10.601562-29.398438-19.101562-8.5-8.300781-15-18.300781-19.101562-29.398438-3.5-9-7.699219-22.601562-8.796876-47.5-1.203124-27-1.5-35.101562-1.5-103.402343s.296876-76.5 1.5-103.398438c1.097657-25 5.296876-38.5 8.796876-47.5 4.101562-11.101562 10.601562-21.199219 19.203124-29.402343 8.296876-8.5 18.296876-15 29.398438-19.097657 9-3.5 22.601562-7.699219 47.5-8.800781 27-1.199219 35.101562-1.5 103.398438-1.5 68.402343 0 76.5.300781 103.402343 1.5 25 1.101562 38.5 5.300781 47.5 8.800781 11.097657 4.097657 21.199219 10.597657 29.398438 19.097657 8.5 8.300781 15 18.300781 19.101562 29.402343 3.5 9 7.699219 22.597657 8.800781 47.5 1.199219 27 1.5 35.097657 1.5 103.398438s-.300781 76.300781-1.5 103.300781zm0 0"></path>
                                                                                <path d="m256.449219 124.5c-72.597657 0-131.5 58.898438-131.5 131.5s58.902343 131.5 131.5 131.5c72.601562 0 131.5-58.898438 131.5-131.5s-58.898438-131.5-131.5-131.5zm0 216.800781c-47.097657 0-85.300781-38.199219-85.300781-85.300781s38.203124-85.300781 85.300781-85.300781c47.101562 0 85.300781 38.199219 85.300781 85.300781s-38.199219 85.300781-85.300781 85.300781zm0 0"></path>
                                                                                <path d="m423.851562 119.300781c0 16.953125-13.746093 30.699219-30.703124 30.699219-16.953126 0-30.699219-13.746094-30.699219-30.699219 0-16.957031 13.746093-30.699219 30.699219-30.699219 16.957031 0 30.703124 13.742188 30.703124 30.699219zm0 0"></path>
                                        ...
                                        <a href="<?= get_the_permalink($sub_field_value); ?>">
                                            <p class="name">
                                                <?= get_the_title($sub_field_value) ?>
                                            </p>
                                        </a>
                                        <a href="<?= get_the_permalink($sub_field_value); ?>">
                                            <p class="designation">
